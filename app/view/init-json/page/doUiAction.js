const content = {
  pageType: "jh-page", pageId: "doUiAction", table: 'student', pageName: "doUiAction", version: 'v2',
  resourceList: [
    {
  ...
  headContent: [
    { tag: 'jh-page-title', value: "doUiAction", attrs: { cols: 12, sm: 6, md:4 }, helpBtn: true, slot: [] },
    { tag: 'v-spacer' },
    // { 
    //   tag: 'jh-search', 
