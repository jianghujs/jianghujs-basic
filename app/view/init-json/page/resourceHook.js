const content = {
  pageType: "jh-page", pageId: "resourceHook", pageName: "resourceHook", version: 'v2',
  resourceList: [
    {
  ...
  headContent: [
    { tag: 'jh-page-title', value: "resourceHook", attrs: { cols: 12, sm: 6, md:4 }, helpBtn: true, slot: [] },
    { tag: 'v-spacer' },
    { 
      tag: 'jh-search', 
      ...
      value: [
        // 年级
        { tag: "v-select", model: "serverSearchWhere.level", attrs: { prefix: "年级", class: 'jh-v-input', ":items": "constantObj.level"} },
        // 性别
        { tag: "v-select", model: "serverSearchWhere.gender", attrs: { prefix: "性别", class: 'jh-v-input', ":items": "constantObj.gender"} },
      ], 
      searchBtn: true
    }
  ],
