const content = {
    pageType: "jh-page", pageId: "dataAccessRight", table: 'student', pageName: "数据权限", version: 'v2',
    resourceList: [
      {
        actionId: "selectItemList",
        resourceType: "service",
        desc: "✅查询列表-student",
        resourceData: {"service": "student", "serviceFunction": "selectStudentList"},
      },
      {
        actionId: "insertItem",
        resourceType: "sql",
    ...
    headContent: [
      { tag: 'jh-page-title', value: "数据权限&nbsp;&nbsp;|&nbsp;&nbsp;当前登录用户只能看到自己所在班级的数据", attrs: { cols: 12, sm: 6, md:4 }, helpBtn: true, slot: [] },
      { tag: 'v-spacer' },
      // { 
      //   tag: 'jh-search', 
